...
export const NavIcons = {
  homeInactive: (props: LucideProps) => (
  ...
  communityInactive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  communityActive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  exploreInactive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  notificationsInactive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  notificationsActive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  profileInactive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  profileActive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  messagesInactive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
  ...
  messagesActive: (props: LucideProps) => (
    <svg viewBox='0 0 24 24' {...props}>
      <g>
        <path
          fill='#fcfcfc'
