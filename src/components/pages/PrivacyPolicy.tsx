  ...
  return (
    <div id='privacy-policy' className="prose prose-stone dark:prose-invert">
      ...
      <p>
        ...
        information that is collected and recorded by Z and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Z. This policy is not applicable to any
      ...
      <p>
        ...
        advertising partners of Z.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Z, which are sent directly to
      ...
      <p>
        Note that Z has no access to or control over these cookies that are used
      ...
      <p>
        Z&apos;s Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Z does not knowingly collect any Personal Identifiable Information from
