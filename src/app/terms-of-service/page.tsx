...
const TermsOfServicePage = () => {
  ...
  return (
    <div className='flex justify-center items-center'>
      ...
      >
        <h3>
          By accessing and using the website located at z.joshuaedo.com
          (referred to as &quot;The Z Network&quot;), you agree to comply with
        ...
        <p>
          ...
          risk and discretion. The Website is provided on an &quot;as is&quot;
        ...
        <p>
          ...
          using the Website, you consent to the collection, processing, and use
          of your information as described in the{' '}
        ...
        <p>
          ...
          graphics, images, and logos, is protected by copyright and other
          intellectual property laws. You may not reproduce, distribute, modify,
          or create derivative works of any content from the Website without our
        ...
        <p>
          ...
          responsible or liable for any damages or losses arising from your use
        ...
        <p>
          ...
          without limitation, breach of these Terms of Service.
        </p>
