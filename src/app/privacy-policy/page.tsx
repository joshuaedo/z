    ...
    <div className='flex justify-center items-center'>
      <div id='privacy-policy' className='prose prose-stone dark:prose-invert'>
        ...
        <p>
          ...
          types of information that is collected and recorded by Z and how we
          use it.
        </p>
        ...
        <p>
          Note that Z has no access to or control over these cookies that are
        ...
        <p>
          Z does not knowingly collect any Personal Identifiable Information
